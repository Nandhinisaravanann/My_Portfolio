...
function App() {
  ...
  <div className="p-6">
    ...
    <p className="text-gray-300 mb-4">
      Built an interactive HR analytics dashboard to monitor key employee metrics such as attrition rate, department-wise headcount, hiring trends, and performance ratings. Enabled HR teams to make data-informed decisions and optimize workforce planning.
    </p>
    <div className="mb-4">
      <h4 className="font-semibold mb-2">Technologies Used:</h4>
      <div className="flex flex-wrap gap-2">
        ...
        <span className="px-3 py-1 bg-gray-600 rounded-full text-sm">Excel</span>
        <span className="px-3 py-1 bg-gray-600 rounded-full text-sm">SQL</span>
      </div>
    </div>
    <a 
      href="https://github.com/Nandhinisaravanann" 
      ...
      <section className="bg-gray-800 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            projects, and professional experience in data analytics.
          </p>
          <a
            href="#"
